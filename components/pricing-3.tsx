...
const plans = [
    {
        ...
        features: ['Maximum 5 notes at a time'],
    },
    {
        name: 'Premium',
        price: '$19',
        period: '/month',
        features: ['Unlimited notes', 'Access to more powerful LLM models'],
        highlighted: true,
        badge: 'Best Value',
    },
]
        ...
        <section className="bg-background @container py-24">
            <div className="mx-auto max-w-2xl px-6">
                <div className="text-center">
                    ...
                    <p className="text-muted-foreground mx-auto mt-4 max-w-md text-balance">Everything you need to never miss a moment. Choose your billing cycle.</p>
                </div>
