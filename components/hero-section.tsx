                    ...
                    <div className="relative pb-32 pt-44">
                        ...
                        <div className="relative z-10 mx-auto w-full max-w-5xl px-6">
                            ...
                            <div className="mx-auto max-w-md text-center">
                                <h1 className="text-balance font-serif text-4xl font-medium sm:text-5xl">Take notes faster. Execute smarter.</h1>
                                <p className="text-muted-foreground mt-4 text-balance">Meeting Memories is your personal secretary.</p>

                                <Button
                                    asChild
                                    className="mt-6 pr-1.5">
                                    <Link href="#link">
                                        <span className="text-nowrap">Take Notes Now</span>
